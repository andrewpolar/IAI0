...
namespace NOT_MIT_KAN_0
{
    internal class AlgebraHelper
    {
        ...
        public double[][] GetProduct(double[][] Left, double[][] Right)
        {
        ...
        public double[][] Pseudo(double[][] X, double[][] Inv)
        {
            int rows = X.GetLength(0);
            int cols = X[0].Length;
            if (rows < cols)
        ...
        public double[][] TwoRectangular(double[][] X, double[][] Y)
        {
            int rows = X.GetLength(0);
            int cols = X[0].Length;
            if (rows < cols)
